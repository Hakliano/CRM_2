...
class Partner(models.Model):
    ...
    key_account_manager = models.ForeignKey(
        User, null=True, blank=True, on_delete=models.SET_NULL, related_name="klienti"
    )
    ...
    sekce_sekundarni = models.ManyToManyField(
        "Sekce", blank=True, related_name="partneri_sekundarni"
    )
...
class KontaktHistorie(models.Model):
    ...
    partner = models.ForeignKey(
        "Partner", on_delete=models.CASCADE, related_name="kontakty"
    )
